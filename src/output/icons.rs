...
impl Icons {
    ...
    const FOLDER_NET: char      = '\u{f0870}'; // 󰡰
    ...
    const VISUALSTUDIO: char    = '\u{e70c}';  // 
    const WRENCH: char          = '\u{f0ad}';  // 
    const XML: char             = '\u{f121}';  // 
...
const DIRECTORY_ICONS: Map<&'static str, char> = phf_map! {
    ...
    "qutebrowser"         => '\u{f375}',            // 
    "root"                => '\u{f0250}',           // 󰉐
    "Seed"                => Icons::FOLDER_NET,     // 󰡰
    "src"                 => '\u{f19fc}',           // 󱧼
    "ssh"                 => Icons::FOLDER_KEY,     // 󰢬
    "sublime-merge"       => Icons::SUBLIME,
    "sublime-text-3"      => Icons::SUBLIME,
...
const FILENAME_ICONS: Map<&'static str, char> = phf_map! {
    ...
    "Kbuild"                 => Icons::OS_LINUX,       // 
    "Kconfig"                => Icons::OS_LINUX,       // 
    "kdeglobals"             => Icons::KDE,            // 
    "kdenliverc"             => Icons::KDE,
    ...
    "rust-toolchain.toml"    => Icons::LANG_RUST,
    "rustfmt.toml"           => Icons::LANG_RUST,      // 
    "rvmrc"                  => Icons::LANG_RUBY,      // 
    "settings.gradle.kts"    => Icons::GRADLE,         // 
    "sha256sum.txt"          => Icons::SHIELD_CHECK,
    "shadow"                 => Icons::LOCK,           // 
    "shard.lock"             => Icons::CRYSTAL,        // 
    "shard.yml"              => Icons::CRYSTAL,        // 
    "shells"                 => Icons::CONFIG,         // 
...
const EXTENSION_ICONS: Map<&'static str, char> = phf_map! {
    ...
    "v"              => '\u{e6ac}',              // 
    "vala"           => '\u{f27d}',              // 
    "vbproj"         => Icons::VISUALSTUDIO,     // 
    "vcxproj"        => Icons::VISUALSTUDIO,
    "vdproj"         => Icons::VISUALSTUDIO,
    "vdf"            => '\u{f1b6}',              // 
